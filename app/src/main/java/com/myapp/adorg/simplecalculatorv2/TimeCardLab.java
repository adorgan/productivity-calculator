...
public class TimeCardLab {
    ...
    private static ContentValues getContentValues(TimeCard timeCard) {
        ...
        values.put(TimeCardDbSchema.TimeCardTable.Cols.PRODUCTIVITY, timeCard.getProductivity());
        ...
        values.put(TimeCardDbSchema.TimeCardTable.Cols.TREATMENT_TIME, timeCard.getmTreatmentTime());
        values.put(TimeCardDbSchema.TimeCardTable.Cols.END_HOUR, timeCard.getmEndHour());
        values.put(TimeCardDbSchema.TimeCardTable.Cols.END_MINUTE, timeCard.getmEndMinute());
        values.put(TimeCardDbSchema.TimeCardTable.Cols.TIME_CARD_DATE, timeCard.getMcardDate().getTime());
        values.put(TimeCardDbSchema.TimeCardTable.Cols.PRODUCTIVITY_INT, timeCard.getmProductivityDouble());
        values.put(TimeCardDbSchema.TimeCardTable.Cols.PAID_TIME_INT, timeCard.getmPaidTimeInt());
